...
\begin{frame}{Employment Distribution by Fiscal Year}
    \centering
    \includegraphics[width=\textwidth,height=0.76\textheight,keepaspectratio]{../output/figures/cmr_nacam_results_doc_labels_ln_emp_density_by_year.png}
\end{frame}

\begin{frame}{Main Elasticity Estimates Across NACAM Sectors}
    \centering
    \includegraphics[width=\textwidth,height=0.76\textheight,keepaspectratio]{../output/figures/cmr_nacam_results_doc_labels_coefficients.png}
\end{frame}

\begin{frame}{Cross-Model Consistency}
    \centering
    \includegraphics[width=\textwidth,height=0.76\textheight,keepaspectratio]{../output/figures/cmr_nacam_results_doc_labels_scatter.png}
\end{frame}
...
\begin{frame}{Selected Sectors From the VA Ranking}
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{lrrrr}
            \input{../output/tables/cmr_nacam_results_doc_labels_highlights.tex}
        \end{tabular}
    }
\end{frame}
