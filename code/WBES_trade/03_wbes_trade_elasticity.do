...
/*******************************************************************************
    Load prepared WBES elasticity file and verify required variables
*******************************************************************************/
...
foreach var in ///
    ...
    isic4_section_fe ln_emp ln_export_value ln_export_value_all ///
    all_firm_sample exporter_only_sample {
